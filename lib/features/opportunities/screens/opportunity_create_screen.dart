...
final class OpportunityCreateScreen extends ConsumerStatefulWidget {
  const OpportunityCreateScreen({super.key});

  @override
  ConsumerState<OpportunityCreateScreen> createState() => _OpportunityCreateScreenState();
}

final class _OpportunityCreateScreenState extends ConsumerState<OpportunityCreateScreen> {
